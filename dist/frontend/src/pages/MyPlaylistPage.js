...
var MyPlaylistPage = function () {
            ...
            (function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, fetchData_1.fetchDataFunc("myPlaylist", id)];
                        case 1:
                            data = _a.sent();
                            setResults(data);
                            return [3 /*break*/, 3];
    ...
    return (<react_bootstrap_1.Container fluid className="outer-container">
      {results === null && (<react_bootstrap_1.Container className="center-container">
          <LoadingPepper_1.default />
        </react_bootstrap_1.Container>)}
      {results !== null && (<react_bootstrap_1.Container className="pt-4">
          <react_bootstrap_1.Row>
            {results && <PlaylistResults_1.default results={results} my={true}/>}
          </react_bootstrap_1.Row>
        </react_bootstrap_1.Container>)}
    </react_bootstrap_1.Container>);
};
exports.default = MyPlaylistPage;
//# sourceMappingURL=MyPlaylistPage.js.map