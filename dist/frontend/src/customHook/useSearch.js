...
var useSearch = function (searchType) {
    var _a = react_1.useState(true), loading = _a[0], setLoading = _a[1];
    var _b = react_1.useState(null), results = _b[0], setResults = _b[1];
    var location = react_router_dom_1.useLocation();
    var search = location.search;
    var searchObj = new URLSearchParams(search);
    var q = searchObj.get("q");
    var p = searchObj.get("p");
    var user = react_1.useContext(UserContextProvider_1.UserContext).user;
    var _c = react_1.useState(null), pageData = _c[0], setPageData = _c[1];
            ...
            (function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, fetchData_1.searchFunc(q, searchType, page)];
                        case 1:
                            data = _a.sent();
                            setPageData({
                                totalPages: Math.min(20, Math.ceil(data.total / 20)),
                                currentPage: page,
                                path: "/search/" + encodeURIComponent(searchType) + "?q=" + encodeURIComponent(q) + "&p=",
                            });
                            setLoading(false);
                            setResults(data);
                            return [3 /*break*/, 3];
